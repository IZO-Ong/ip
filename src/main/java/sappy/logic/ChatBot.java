...
public class ChatBot {
    ...
    public String getResponse(String input) {
        if (input == null || input.trim().isEmpty()) {
            return "Coo? Did a bug catch your tongue?";
        }
        ...
        try {
            ...
            case LIST:
                return listTasks();
            case MARK:
                return markTaskDone(Parser.parseId(input));
            case UNMARK:
                return markTaskUndone(Parser.parseId(input));
            case REMOVE:
                return removeTask(Parser.parseId(input));
            case FIND:
                return findTasks(Parser.parseKeyword(input));
            case TODO:
                return addToDo(Parser.parseToDoDetails(input));
            case DEADLINE:
                return addDeadline(Parser.parseDeadlineDetails(input));
            case EVENT:
                return addEvent(Parser.parseEventDetails(input));
            default:
